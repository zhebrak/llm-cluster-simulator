...
const WINNING_OVERRIDES: Record<string, Partial<TaskSetup>> = {
  ...
  'inference-intermediate-04': { tensorParallel: 4 },
  'inference-intermediate-05': { kvCachePrecision: 'fp8' },
  'inference-intermediate-06': { tensorParallel: 8, batchSize: 48 },
  'inference-intermediate-07': { tensorParallel: 4, weightPrecision: 'int4', batchSize: 4 },
  ...
  'inference-advanced-04': { tensorParallel: 8 },
